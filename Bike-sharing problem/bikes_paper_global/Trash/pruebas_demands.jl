...
Qᵢ = [19,15,15,15,15,19,15,19,23,19,15,23,19,15,19,23,15,27,19,19,15,15,19,27,19,23,19,19,23,15,23,19,19,27]
...
for repetition in 1:n_rep
    ...
    for id_row in 1:x
        ...
        @show return_ŷₗₛ.*rat_gᵢ + withd_ŷₗₛ.*rat_hᵢ .- Qᵢ
        println("")
        #@show return_normal_cart_y.*rat_gᵢ + withd_normal_cart_y.*rat_hᵢ .- Qᵢ
