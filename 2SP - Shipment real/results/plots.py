...
ax = sns.boxplot(y="OG", hue="method", data= df1[df1["T"]==100],ax = axes[1,0],palette = ['tab:blue' , 'tab:green','tab:red', 'tab:brown'])
ax.get_legend().remove() 
ax.set(ylim=(0, 5))
ax = sns.boxplot(y="OG", hue="method", data= df1[df1["T"]==1000],ax = axes[1,1],palette = ['tab:blue' , 'tab:green','tab:red', 'tab:brown'])
ax.get_legend().remove()
ax.set(ylim=(0, 5)) 
ax = sns.boxplot(y="OG", hue="method", data= df1[df1["T"]==10000],ax = axes[1,2],palette = ['tab:blue' , 'tab:green','tab:red', 'tab:brown'])
ax.get_legend().remove()
ax.set(ylim=(0, 5))
...
ax = sns.boxplot(y="OG", hue="method", data= df2[df2["T"]==100],ax = axes[2,0],palette = ['tab:blue' , 'tab:green','tab:red', 'tab:brown'])
ax.get_legend().remove() 
ax.set(ylim=(0, 10))
ax = sns.boxplot(y="OG", hue="method", data= df2[df2["T"]==1000],ax = axes[2,1],palette = ['tab:blue' , 'tab:green','tab:red', 'tab:brown'])
ax.get_legend().remove()
ax.set(ylim=(0, 10)) 
ax = sns.boxplot(y="OG", hue="method", data= df2[df2["T"]==10000],ax = axes[2,2],palette = ['tab:blue' , 'tab:green','tab:red', 'tab:brown'])
ax.get_legend().remove()
ax.set(ylim=(0, 10))
